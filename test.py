...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|          Twoaha Ibn Jalal                 |
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;91m [⚡\033[1;97mAuthor Name: Twoaha Ibn Jalal     ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mTwoaha\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mHuntter\033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "Twoaha"
CorrectPassword = "Rubaiya"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Twoaha_Ibn_Jalal
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Twoaha_Ibn_Jalal
	print logo
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mTwoaha\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
